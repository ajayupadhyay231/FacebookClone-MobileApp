    ...
    //  <KeyboardAvoidingView style={styles.container} behavior={'padding'}>
      <ScrollView style={styles.main_view} >
        ...
        <View style={styles.top_div} >
          ...
          <TouchableOpacity style={styles.login_button} onPress={handleCreateAccountClick}><Text style={styles.login_button_text}>Create Account</Text></TouchableOpacity>
          <Text style={styles.forgot_password_text}>Forgot Password?</Text>
        </View>
        <View style={styles.bottom_div}>
          <TouchableOpacity style={styles.create_new_account}><Text style={styles.create_new_account_text} onPress={handleCreateAccountClick}>Create new account</Text></TouchableOpacity>
